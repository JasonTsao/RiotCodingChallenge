...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rune.secondary_effect_type'
        db.add_column(u'static_data_rune', 'secondary_effect_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rune.secondary_effect_type'
        db.delete_column(u'static_data_rune', 'secondary_effect_type')
    ...
    models = {
        ...
        u'static_data.rune': {
            ...
            'secondary_effect_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
